...
if(gazebo_FOUND)
	...
	#builds the necessary symlink. It's supposed to solve a race
	#between generating the headers and using the headers
	file(MAKE_DIRECTORY ${PX4_BINARY_DIR}/mavlink_shim/mavlink)
	file(CREATE_LINK ${PX4_BINARY_DIR}/mavlink ${PX4_BINARY_DIR}/mavlink_shim/mavlink/v2.0 SYMBOLIC)
	...
	ExternalProject_Add(sitl_gazebo-classic
		...
		CMAKE_ARGS
			...
			-DCMAKE_DISABLE_FIND_PACKAGE_MAVLink=ON
			-DMAVLINK_INCLUDE_DIRS=${PX4_BINARY_DIR}/mavlink_shim
		BINARY_DIR ${PX4_BINARY_DIR}/build_gazebo-classic
		INSTALL_COMMAND ""
		DEPENDS git_sitl_gazebo-classic mavlink_c_generate
	...
	add_custom_target(gazebo-classic DEPENDS gazebo-classic_iris__windy) # alias
	add_custom_target(gazebo DEPENDS gazebo-classic_iris__windy) # alias
